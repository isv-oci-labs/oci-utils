...
function oci-curl {
	...
	local tenancyId="ocid1.tenancy.oc1..aaaaaaaaro7aox2fclu4urtpgsbacnrmjv46e7n4fw3sc2wbq24l7dzf3kba";
	local authUserId="ocid1.user.oc1..aaaaaaaapcbsn73kfyjcoybucswd4iw7avp62sclchiegnmrfteyyaz4v4jq";
	local keyFingerprint="9e:52:75:6b:4f:87:56:ec:1e:6c:a1:a7:29:0c:f6:75";
	local privateKeyPath="oci_api_key_oci.pem";
